...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white dark:bg-[#0b0c0e] border-t border-line dark:border-[#1a1c20] z-50">
      <div className="flex justify-around items-start h-20 pt-2.5 max-w-sm mx-auto">
        {TABS.map(({ to, label, icon: Icon }) => (
          <NavLink
            ...
            className={({ isActive }) =>
              `flex flex-col items-center justify-center gap-1 flex-1 text-[10px] font-medium ${
